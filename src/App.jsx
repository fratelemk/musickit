...
export function App() {
    ...
    const ghostBtn =
        'px-3 py-1.5 rounded-full ring-1 ring-white/10 bg-white/5 text-zinc-200 text-sm hover:bg-white/10 hover:ring-white/20 transition';
                        ...
                        {playlist && currentTrack && (
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className="px-4 py-2.5 rounded-full ring-1 ring-rose-400/30 bg-rose-500/10 text-rose-200 font-medium hover:bg-rose-500/20 hover:ring-rose-400/50 disabled:opacity-40 disabled:cursor-not-allowed transition"
                                >
                                    Reject
                                </button>
                                <button
                                    ...
                                    disabled={currentInPlaylist}
                                    className="px-4 py-2.5 rounded-full ring-1 ring-emerald-400/30 bg-emerald-500/10 text-emerald-200 font-medium hover:bg-emerald-500/20 hover:ring-emerald-400/50 disabled:opacity-40 disabled:cursor-not-allowed transition"
                                >
                                    Approve
                                </button>
                            </div>
        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    <div
                        className="max-h-56 overflow-auto rounded-lg ring-1 ring-white/10 bg-black/40 p-3 flex flex-wrap gap-2">
                        {allGenres.map((g) => {
                ...
                <div className="flex justify-end gap-2 pt-2">
                    <button type="button" onClick={onClose}
                            className="px-4 py-2 rounded-lg text-zinc-300 hover:text-white">
                        Cancel
                    </button>
                    <button
                        type="submit"
